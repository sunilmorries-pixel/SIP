 ...
 *
 * `days` revised 2026-08-17 from the "SLA sheet" Google Sheet (SLA-New tab,
 * https://docs.google.com/spreadsheets/d/1MDjUSX2NSRrvFXXanovs7Tk7zhO8oTfy83-eZiRJ-Uc,
 * column E "SLA by Mustaq in days") — 61 categories changed, one added
 * (International Camp Request). Tech/Non-Tech classification unchanged
 * (verified to already agree with the sheet's Type column for every row).
 */
var SLA_CATALOG = [
  ...
  { name: 'Billing Name Change', days: 3, tech: false },
  { name: 'Duplicate Ticket', days: 0, tech: false },
  { name: 'Lead cable', days: 6, tech: true },
  { name: 'Spoke Change Request', days: 9, tech: true },
  ...
  { name: 'ECG Paper', days: 6, tech: false },
  { name: 'Trilink Issue', days: 1, tech: true },
  { name: 'Request for ownership Transfer', days: 7, tech: false },
  { name: 'Service Request', days: 5, tech: true },
  { name: 'Remove Contact', days: 2, tech: false },
  { name: 'Deactivation Request', days: 25, tech: false },
  { name: 'V-Cardia lead cable issue', days: 6, tech: true },
  { name: 'Limb Lead / Chest Lead Reversal', days: 6, tech: true },
  ...
  { name: 'Clarification of ECG Report/Diagnosis', days: 1, tech: false },
  { name: 'Keypad', days: 6, tech: true },
  { name: 'Acquisition Delay -WIFI Issue', days: 3, tech: true },
  { name: 'Software Issue', days: 6, tech: true },
  { name: 'Printer', days: 6, tech: true },
  { name: 'V-Cardia App Issue', days: 2, tech: false },
  { name: 'Change Of Customer/Company Name/Address', days: 6, tech: false },
  { name: 'Spare Inventory', days: 6, tech: true },
  { name: 'V-Cardia keypad', days: 6, tech: true },
  { name: 'Training Request', days: 5, tech: true },
  { name: 'Display', days: 6, tech: true },
  { name: 'Temporary Suspension', days: 6, tech: false },
  { name: 'Report Missing', days: 1, tech: false },
  { name: 'Poor Quality/Repeat ECG', days: 6, tech: true },
  { name: 'Power Adapter Damage', days: 6, tech: true },
  { name: 'Camp Request', days: 6, tech: false },
  { name: 'ECG Billing Clarity', days: 2, tech: false },
  { name: 'Machine Water Clogging Damage', days: 9, tech: true },
  { name: 'Monthly Invoice Request', days: 3, tech: false },
  { name: 'Temporary swapping', days: 5, tech: true },
  { name: 'Activation/Installation Request', days: 9, tech: true },
  { name: 'Payment Collection', days: 8, tech: false },
  { name: 'Bulbs/ Clamps', days: 5, tech: true },
  { name: 'Delay in Reporting due to Downtime', days: 1, tech: false },
  { name: 'V-Cardia machine replaced', days: 5, tech: true },
  { name: 'Tricog Document Request', days: 4, tech: false },
  { name: 'Business/Sales Query', days: 2, tech: false },
  { name: 'Gel Bottle', days: 7, tech: false },
  { name: 'Product Training Request', days: 3, tech: false },
  { name: 'Lead Cable Damage', days: 6, tech: true },
  { name: 'Mother Board', days: 9, tech: true },
  { name: 'Connector /Serial/Charging Pin', days: 7, tech: true },
  ...
  { name: 'Print Issue', days: 5, tech: true },
  { name: 'Cardio Net access', days: 1, tech: false },
  { name: 'HR-Query', days: 1, tech: false },
  { name: 'Hubbr credentials', days: 1, tech: false },
  { name: 'Feed Back Ticket', days: 3, tech: false },
  { name: 'Antenna', days: 4, tech: true },
  { name: 'UPS Issue', days: 30, tech: true },
  { name: 'Demo Request', days: 5, tech: true },
  { name: 'Echo Data Upload', days: 1, tech: false },
  { name: 'Critical Call Concerns', days: 1, tech: false },
  { name: 'Calibration Certificate', days: 6, tech: true },
  { name: 'Phone Issue', days: 6, tech: false },
  { name: 'Equipment Stolen/misplaced', days: 7, tech: false },
  { name: 'Skip Echo case', days: 2, tech: false },
  { name: 'Mac 600 To V-Cardia(Swapping)', days: 10, tech: true },
  { name: 'V-Cardia Logs', days: 7, tech: true },
  { name: 'Junk', days: 2, tech: false },
  { name: 'Machine issue', days: 7, tech: true },
  { name: 'Power Chord', days: 7, tech: true },
  { name: 'Mobile Compatibly Issue', days: 4, tech: false },
  ...
  { name: 'IVR Critical Call', days: 1, tech: false },
  { name: 'Expansion Order', days: 15, tech: false },
  { name: 'Digitization Request', days: 3, tech: false },
  { name: 'Printer Roller Missing', days: 6, tech: true },
  { name: 'Product Enhancement/Data Request', days: 20, tech: false },
  { name: 'Hard/ software reset button', days: 6, tech: true },
  { name: 'New Process Update', days: 3, tech: false },
  { name: 'IT Related issue', days: 3, tech: false },
  { name: 'Barcode Activation', days: 1, tech: true },
  { name: 'Mac Battery Pin', days: 7, tech: true },
  { name: 'Sim card Tray', days: 7, tech: true },
  { name: 'Phone Stolen', days: 15, tech: false },
  { name: 'General Report Related Query', days: 1, tech: false },
  ...
  { name: 'Churn Pickup', days: 25, tech: false },
  { name: 'NPA MH', days: 7, tech: true },
  { name: 'International Camp Request', days: 5, tech: false },
  { name: 'NPA', days: 5, tech: false },
  { name: 'Ethernet/USB Cable-TR 200', days: 7, tech: true },
  { name: 'Refund Request', days: 6, tech: false },
