 ...
 */
function buildDashboardQuerySpecs(hub) {
  var p = { hub: hub || '' };
  var NOW_IST_SQL = nowIstSql_();
  ...
  return [
    ...
    },
    {
      ...
      sql:
        ...
        "WHERE " + HUB_FILTER_SQL + " AND LastTimeStamp >= TIMESTAMP_SUB(" + NOW_IST_SQL + ", INTERVAL 30 DAY) " +
    ...
    /* ═══════════ SUPPORT / CS VIEW — Zoho ticket analytics ══════════════ */
    {
      ...
      sql:
        ...
        " FROM " + T('zoho_data') + " WHERE " + HUB_FILTER_SQL + ") " +
        "SELECT " +
    ...
    },
    {
      ...
      sql:
        ...
        zohoParsedDates_() + " FROM " + T('zoho_data') + " WHERE " + HUB_FILTER_SQL + "), " +
    ...
    },
    {
      ...
      params: p,
      sql:
        "WITH t AS (SELECT " + zohoParsedDates_() + " FROM " + T('zoho_data') + " WHERE " + HUB_FILTER_SQL + ") " +
    ...
    },
    {
      ...
      sql:
        ...
        "WHERE " + HUB_FILTER_SQL + " AND status NOT IN " + CONFIG.ZOHO_TERMINAL_STATUSES + " " +
    ...
    },
    {
      ...
      params: p,
      sql:
        "WITH t AS (SELECT IssueCategory, HubName, " +
        ...
        "FROM t WHERE " + HUB_FILTER_SQL + " AND created >= DATETIME_SUB(CURRENT_DATETIME(), INTERVAL 90 DAY) " +
    ...
    },
    {
      ...
      params: p,
      sql:
        "WITH t AS (SELECT priority, HubName, " +
        " SAFE.PARSE_DATETIME('" + CONFIG.ZOHO_DT_FORMAT + "', CreatedAt) AS created " +
        " FROM " + T('zoho_data') + ") " +
    ...
    },
    {
      ...
      params: p,
      sql:
        "WITH t AS (SELECT Channel, HubName, " +
        " SAFE.PARSE_DATETIME('" + CONFIG.ZOHO_DT_FORMAT + "', CreatedAt) AS created " +
        " FROM " + T('zoho_data') + ") " +
